 ...
 *
 * Este projeto requer: OUTPUT_FOLDER_ID, BACKUP_FOLDER_ID.
 */

var DRIVE_FOLDER_REQUIRED_KEYS = ['OUTPUT_FOLDER_ID', 'BACKUP_FOLDER_ID'];

const DRIVE_FOLDER_ALIASES = Object.freeze({
